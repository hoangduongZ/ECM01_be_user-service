...
public class AuthController {
    ...
    public ResponseEntity<?> deactivateUser(@PathVariable("uuid") UUID uuid){
        authService.deactivateUser(uuid);
        return ResponseEntity.ok("Deactivate user "+ uuid.toString() + " success");
    }
}
